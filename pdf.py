...
class ImageParagraph(Flowable):
    ...
    def wrap(self, availWidth, availHeight):
        ...
        print(f"Image Size: Width={self.img_width}, Height={self.img_height}")
        print(f"Text Size: Width={text_width}, Height={text_height}")
...
right_column_content = [
    ...
    Paragraph("197456", centered_text_style),
    Paragraph("Data:", centered_bold_style),
    Paragraph("26/10/2024", centered_text_style)
]
